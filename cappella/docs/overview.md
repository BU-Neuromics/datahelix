...
**Cappella** is the harmonization engine of the DataHelix platform. Its job is to make data from many different sources sing together in a single, consistent, provenance-rich picture.
