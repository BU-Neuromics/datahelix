...
**Decision of record:** [Aperture ADR-0041](../aperture/design/decisions/ADR-0041-referenced-class-slots-projection-vs-presentation.md)
...
- **`exon-conversational-turn-core`** (57 commits, never PR'd) carries the 15-collection demo
  schema *and* now the four `inverse:` declarations. Until it lands, `main` has four classes
  and reverse traversal is exercised only by the certification fixture.
