...
| `roadmap-1.0.md` | **DataHelix 1.0 roadmap** — six-month design-sprint output (2026-07-07): four phases to a certified 1.0 across hippo/aperture/drylims. Ratified scope: Bridge minimal in 1.0 (multi-user), portal-complete + MCP agent surface, one Cappella reference adapter. Epic tables with acceptance criteria for agent handoff; supersedes `FABLE_HANDOFF.md` §6 milestones where they conflict. | 🟠 Working |
